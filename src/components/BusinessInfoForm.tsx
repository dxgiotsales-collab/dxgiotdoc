            ...
            <div key={m.id} className="flex items-end gap-2">
              <div className="flex-1 space-y-1">
                ...
                <input
                  ...
                  placeholder="먼지"
                  value={m.pollutant}
                  onChange={(e) => updateMeasurementItem(m.id, "pollutant", e.target.value)}
                />
              </div>
              <div className="w-20 space-y-1">
                ...
                <input
                  type="number"
                  className="dxg-input text-center"
                  placeholder="2.0"
                  value={m.amount}
                  onChange={(e) => updateMeasurementItem(m.id, "amount", e.target.value)}
                />
              </div>
              <div className="w-24 space-y-1">
                ...
                <select
                  className="dxg-input"
                  value={m.unit}
                  onChange={(e) => updateMeasurementItem(m.id, "unit", e.target.value)}
                >
              ...
              <div className="w-36 space-y-1">
                ...
                <input
                  ...
                  className="dxg-input"
                  value={m.date}
                  onChange={(e) => updateMeasurementItem(m.id, "date", e.target.value)}
                />
              </div>
              <Button
                type="button"
                ...
                size="icon"
                className="h-8 w-8 shrink-0 text-muted-foreground hover:text-destructive"
                onClick={() => removeMeasurementItem(m.id)}
              >
                <Minus className="h-3.5 w-3.5" />
              </Button>
            </div>
